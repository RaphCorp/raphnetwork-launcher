...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "hmmmmmmm j'existe enfin?", "author": "raph_rapide100" },
            { "message": "une version moddé il disent intéressant", "author": "raph_rapide100" },
            { "message": "visiblement vivant", "author": "raph_rapide100" }
        ];
